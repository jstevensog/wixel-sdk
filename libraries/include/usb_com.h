...
#include <time.h>
#include <com.h>
/*! additional typedef added by Adrien de Croy
*/
...
/*! Added by Adrien de Croy.  Used to request the system to go into bootloader mode soon.  This is so we can do this from
 * protocol  */
